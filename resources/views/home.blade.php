        ...
        <section class="jarallax d-flex align-items-stretch min-vh-100 bg-dark overflow-hidden pt-5" data-jarallax
            ...
            <div class="container d-flex flex-column justify-content-around pt-5 pt-sm-4 pb-5">
                <div class="row mt-md-5 pt-sm-5">
                    <div class="col-lg-4 col-md-5 order-md-1 order-2 text-md-start text-center">
                        <div class="mt-lg-5 mb-4">
                            <a href="https://www.youtube.com/watch?v=4gAtw4qSF2U" class="btn-video me-3"
                                data-gallery-video
                ...
                <div class="row d-md-flex d-none align-items-center mt-lg-n5">
                    <div class="col-4">
                        <ul
                            class="ps-4 list-unstyled border-start border-primary fw-bold text-muted text-uppercase lead">
                            <li>UX / UI</li>
                    ...
                    <div class="accordion" id="accordionServices">
                        ...
                        <div class="accordion-item">
                            <h3 class="accordion-header" id="servicesHeading-2">
                                <button class="accordion-button border-0 collapsed" type="button"
                                    data-bs-toggle="collapse" data-binded-content="#web"
                                    data-bs-target="#servicesCollapse-2" aria-expanded="false"
                        ...
                        <div class="accordion-item">
                            <h3 class="accordion-header" id="servicesHeading-3">
                                <button class="accordion-button border-0 collapsed" type="button"
                                    data-bs-toggle="collapse" data-binded-content="#photography"
                                    data-bs-target="#servicesCollapse-3" aria-expanded="false"
                                    aria-controls="servicesCollapse-3">Photography &amp; Video Production</button>
                            </h3>
                ...
                <div class="col-lg-6 col-md-7 order-md-2 order-1 ms-auto">
                    ...
                    <div class="binded-content mb-4">
                        <div id="identity" class="binded-item active">
                            <img class="d-block" src="assets/img/home/services/01.svg"
                                alt="Identity Design &amp; Illustration">
                        </div>
                        <div id="web" class="binded-item">
                            <img class="d-block" src="assets/img/home/services/02.svg" alt="UX / UI Design">
                        </div>
                        <div id="photography" class="binded-item">
                            <img class="d-block" src="assets/img/home/services/03.svg"
              ...
              "responsive": {
                ...
                "768": {
                  "items": 3
                        ...
                        <div class="rounded">
                            <a class="portfolio-card-scale text-decoration-none mt-3 mx-3"
                                href="portfolio-single-v1.html">
                                <div class="portfolio-card-img">
                                    <img src="assets/img/portfolio/01.jpg" alt="Card image">
                                </div>
                        ...
                        <div class="rounded">
                            <a class="portfolio-card-scale text-decoration-none mt-3 mx-3"
                                ...
                                <div class="portfolio-card-img">
                                    <img src="assets/img/portfolio/02.jpg" alt="Card image">
                                </div>
                                <div class="portfolio-card-body">
                        ...
                        <div class="rounded">
                            <a class="portfolio-card-scale text-decoration-none mt-3 mx-3"
                                href="portfolio-single-v1.html">
                                <div class="portfolio-card-img">
                                    <img src="assets/img/portfolio/03.jpg" alt="Card image">
                                </div>
                                <div class="portfolio-card-body">
                ...
                "items": 6
                    ...
                    <div class="px-3 text-center">
                        <a href="#" class="swap-image">
                            ...
                            <img src="assets/img/logo/coca-cola-g.svg" class="swap-from" width="120"
                                alt="Brand logo">
                        </a>
                    </div>
                    <div class="px-3 text-center">
                    ...
                    <div class="px-3 text-center">
                        <a href="#" class="swap-image">
                            <img src="assets/img/logo/albatron.svg" class="swap-to" width="120"
                                alt="Brand logo hover">
                            <img src="assets/img/logo/albatron-g.svg" class="swap-from" width="120"
                                alt="Brand logo">
                        </a>
                    </div>
                    <div class="px-3 text-center">
                        <a href="#" class="swap-image">
                            <img src="assets/img/logo/wisecat.svg" class="swap-to" width="120"
                                alt="Brand logo hover">
                            <img src="assets/img/logo/wisecat-g.svg" class="swap-from" width="120"
                                alt="Brand logo">
                        </a>
                    </div>
                    <div class="px-3 text-center">
                        <a href="#" class="swap-image">
                            <img src="assets/img/logo/curtis.svg" class="swap-to" width="120"
                                alt="Brand logo hover">
                            <img src="assets/img/logo/curtis-g.svg" class="swap-from" width="120"
                                alt="Brand logo">
                        </a>
                    </div>
                    <div class="px-3 text-center">
                        <a href="#" class="swap-image">
                            <img src="assets/img/logo/gabor.svg" class="swap-to" width="120"
                                alt="Brand logo hover">
                    ...
                    <div class="px-3 text-center">
                        <a href="#" class="swap-image">
                            <img src="assets/img/logo/huggies.svg" class="swap-to" width="120"
                                alt="Brand logo hover">
                            <img src="assets/img/logo/huggies-g.svg" class="swap-from" width="120"
                                alt="Brand logo">
                        </a>
                    </div>
                    <div class="px-3 text-center">
                        <a href="#" class="swap-image">
                            <img src="assets/img/logo/lovato.svg" class="swap-to" width="120"
                                alt="Brand logo hover">
                            <img src="assets/img/logo/lovato-g.svg" class="swap-from" width="120"
                                alt="Brand logo">
                        </a>
                    </div>
                    <div class="px-3 text-center">
                        <a href="#" class="swap-image">
                            <img src="assets/img/logo/xrite.svg" class="swap-to" width="120"
                                alt="Brand logo hover">
                    ...
                    <div class="px-3 text-center">
                        <a href="#" class="swap-image">
                            <img src="assets/img/logo/rainx.svg" class="swap-to" width="120"
                                alt="Brand logo hover">
                    ...
                    <div class="px-3 text-center">
                        <a href="#" class="swap-image">
                            <img src="assets/img/logo/exxon.svg" class="swap-to" width="120"
                                alt="Brand logo hover">
                ...
                <div
                    ...
                    <div class="d-flex flex-sm-column justify-content-center mb-lg-0 mb-3 px-3">
                        <a href="#" class="swap-image me-sm-0 me-3 mb-3">
                            <img src="assets/img/logo/webby.svg" class="swap-to" width="60"
                                alt="Brand logo hover">
                    ...
                    <div class="d-flex flex-sm-column justify-content-center mb-lg-0 mb-3 px-3">
                        <a href="#" class="swap-image me-sm-0 me-3 mb-3">
                            <img src="assets/img/logo/cssda.svg" class="swap-to" width="60"
                                alt="Brand logo hover">
                    ...
                    <div class="d-flex flex-sm-column justify-content-center mb-lg-0 mb-3 px-3">
                        <a href="#" class="swap-image me-sm-0 me-3 mb-3">
                            <img src="assets/img/logo/awwwards.svg" class="swap-to" width="60"
                                alt="Brand logo hover">
                            <img src="assets/img/logo/awwwards-g.svg" class="swap-from" width="60"
                                alt="Brand logo">
                        </a>
                    ...
                    <div class="d-flex flex-sm-column justify-content-center mb-lg-0 mb-3 px-3">
                        <a href="#" class="swap-image me-sm-0 me-3 mb-3">
                            <img src="assets/img/logo/fwa.svg" class="swap-to" width="60"
                                alt="Brand logo hover">
                    ...
                    <div class="accordion" id="accordionTeam">
                        ...
                        <div class="accordion-item">
                            <h3 class="accordion-header h5" id="teamHeading-2">
                                <button class="accordion-button py-2 border-0 collapsed" type="button"
                                    data-bs-toggle="collapse" data-binded-content="#team2"
                                    data-bs-target="#teamCollapse-2" aria-expanded="false"
                                    aria-controls="teamCollapse-2">Theresa Cooper</button>
                            </h3>
                        ...
                        <div class="accordion-item">
                            <h3 class="accordion-header h5" id="teamHeading-3">
                                <button class="accordion-button py-2 border-0 collapsed" type="button"
                                    data-bs-toggle="collapse" data-binded-content="#team3"
                                    data-bs-target="#teamCollapse-3" aria-expanded="false"
                                    aria-controls="teamCollapse-3">Debra Warren</button>
                            </h3>
                        ...
                        <div class="accordion-item">
                            <h3 class="accordion-header h5" id="teamHeading-4">
                                <button class="accordion-button py-2 border-0 collapsed" type="button"
                                    data-bs-toggle="collapse" data-binded-content="#team4"
                                    data-bs-target="#teamCollapse-4" aria-expanded="false"
                                    aria-controls="teamCollapse-4">Dustin Williamson</button>
                            </h3>
